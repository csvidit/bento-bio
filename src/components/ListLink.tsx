...
const ListLink = (props: {
  ...
  return (
    <Link
      ...
      href={props.href}
      className="group p-2 lg:p-4 col-span-4 flex flex-row justify-between items-center bg-white rounded-lg transition-all duration-200 ease-in-out hover:ring hover:ring-gray-300 hover:shadow-lg hover:shadow-[#0000FF]"
    >
